...
<a href="${cpath }/board"><button>계시판 입장</button></a>
<h3>계시판 만들기 계획</h3>
<ol>
	<li><details>
			...
			<ul>
				...
				<li>데이터(계시글)의 형식이 결정되면 DB에 테이블을 작성한다</li>
			...
			<table>
				...
				<tr>
					...
					<td>numver</td>
					<td>primary key</td>
					<td>계시글 번호, 자동으로 증가하기 위해 oracle DB 의 sequence를 사용</td>
				</tr>
				<tr>
					<td>title</td>
					<td>varchar2(50)</td>
					<td>not null</td>
					<td>계시글 제목, 빈 값을 저장할 수 없다, 크기 50 byte (한글 25자)</td>
				</tr>
				<tr>
					<td>content</td>
					<td>varchar2(2000)</td>
					<td>not null</td>
					<td>계시글 내용, 빈 값을 저장할 수 없다, 크기 2000 byte (한글 1000자)</td>
				</tr>
				<tr>
					<td>writeDate</td>
					<td>date</td>
					<td>default sysdate</td>
					<td>계시글 작성날짜, 기본값은 오늘 날짜 현재 시간</td>
				</tr>
				<tr>
					<td>viewCount</td>
					<td>number</td>
					<td>default 0</td>
					<td>계시글 조회수, 기본값은 0</td>
				</tr>
			</table>
			<fieldset>
				<pre>
